...
export default function Home() {
    return (
      <section className="min-h-screen bg-secondary text-primary mt-[-2rem] 2xl:mt-[-10rem]">
        <div className="mx-5 xs:mx-10 sm:mx-14 md:mx-24 lg:mx-44 2xl:mx-72">
          ...
          <div className="text-center mt-16">
            <Link href="#" target="_blank" rel="noopener noreferrer" className="text-highlight hover:underline">
              Veja mais projetos
            </Link>
          </div>
        </div>
