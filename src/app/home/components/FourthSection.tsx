  ...
  return (
    <section className="bg-secondary text-primary mt-[-2rem] 2xl:mt-[-10rem]">
      <div className="mx-5 xs:mx-10 sm:mx-14 md:mx-24 lg:mx-44 2xl:mx-72">
        <h1 id="get-to-know-my-projects" className="text-center font-spaceGrotesk font-medium text-gray-300 mb-16 text-2xl sm:text-3xl lg:text-3xl xl:text-4xl 2xl:text-5xl">
          Conheça os{" "}
