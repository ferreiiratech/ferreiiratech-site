...
export const metadata: Metadata = {
    ...
    description: "Criação profissional de landing pages que maximizam conversões e geram leads qualificados. " +
    ...
    openGraph: {
        ...
        description:"Criação profissional de landing pages focadas em conversão e geração de leads.",
        images: [{
            url: "/og-image.png",
            width: 1200,
            height: 630,
